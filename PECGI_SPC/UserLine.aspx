<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UserLine.aspx.vb" Inherits="PECGI_SPC.UserLine" %>
...
<script type="text/javascript">
    ...
    function OnAccessCheckedChanged(s, e) {
        ...
        for (var i = 0; i < gridMenu.GetVisibleRowsOnPage(); i++) {
            if (gridMenu.batchEditApi.GetCellValue(i, "Allow", false) != s.GetValue()) {
                gridMenu.batchEditApi.SetCellValue(i, "Allow", s.GetValue());
            }
        }
    }
					...
					<article class="col-sm-12 col-md-12 col-lg-12">
						...
						<div class="jarviswidget" id="wid-id-0" data-widget-deletebutton="false" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            <header>
								...
								<h2><strong><asp:Label ID="Label1" runat="server" Text="User Lines"></asp:Label></strong></h2>
                            </header>
								<!-- widget div-->
                            <div>
						        <!-- widget content -->
...
<dx:ASPxGridView ID="gridMenu" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridMenu"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="Line ID" FieldName="LineID"
...
<CellStyle Font-Names="Segoe UI" Font-Size="8pt" HorizontalAlign="Left"></CellStyle>
                        ...
                        <dx:GridViewDataCheckColumn Caption="" FieldName="Allow"
